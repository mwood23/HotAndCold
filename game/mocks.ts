import { ChallengeLeaderboardResponse, SingleGame, PlayerProgress } from './shared';

/**
 * Mocks are ran when the game is started with Vite's
 */
export const PLAYING_GAME: Partial<SingleGame> = {
  'number': 14,
  'challengeUserInfo': {
...
export const WINNING_GAME: Partial<SingleGame> = {
  'number': 14,
  'challengeUserInfo': {
    'username': 'UnluckyHuckleberry53',
    'score': {
...
export const GIVE_UP_GAME: Partial<SingleGame> = {
  'number': 10,
  'challengeUserInfo': {
    'username': 'UnluckyHuckleberry53',
    'score': undefined,
